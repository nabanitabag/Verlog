...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='minihack_ppo_qwen3b' \
    ...
    envs.env_name=minihack \
    envs.task=MiniHack-Corridor-R2-v0 \
    envs.minihack_kwargs.penalty_time=0.0 \       # ← set > 0 for your paper!
    envs.minihack_kwargs.max_episode_steps=150 \
    ...
    data.train_files=$HOME/minihack/train.parquet \
    data.val_files=$HOME/minihack/test.parquet 2>&1 | tee verlog_run.log